...
mod tests {
    ...
    const FRAME_SIZE_SMALL: u8 = 1;
    const FRAME_SIZE_MEDIUM: u8 = 5;
    const FRAME_SIZE_LARGE: u8 = 15;
    ...
    fn td_target_spec_valid_range_returns_some() {
        ...
        assert!(TdTargetSpec::for_frame_inches(FRAME_SIZE_SMALL).is_some());
        assert!(TdTargetSpec::for_frame_inches(FRAME_SIZE_MEDIUM).is_some());
        assert!(TdTargetSpec::for_frame_inches(FRAME_SIZE_LARGE).is_some());
    }
