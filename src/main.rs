...
use crate::plot_functions::plot_psd_dB_heatmap::plot_psd_dB_heatmap; // NEW: Import dB heatmap
use crate::plot_functions::plot_psd_throttle_heatmap::plot_psd_throttle_heatmap; // NEW: Import throttle heatmap
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    plot_psd_throttle_heatmap(&all_log_data, &root_name, sample_rate)?; // NEW
