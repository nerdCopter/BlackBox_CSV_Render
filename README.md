...
=== PLOT TYPE SELECTION ===
  ...
  --extended       All plots except Bode — adds PIDsum/Error, PID Activity,
                   Setpoint Derivative, Gyro PSD, D-term PSD, heatmaps,
                   Stick Distribution, and Motor vs eRPM (requires
